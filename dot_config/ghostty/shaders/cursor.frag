// Ghostty Master Shader — Silky Smooth Liquid Cursor Trail, Clean Keypress-Only Connected Reticle & Seamless Character Drop
...
void mainImage(out vec4 frag_color, vec2 frag_coord) {
  ...
  // 3. Animated Cursor Trailing Tail & Clean Keypress-Only Connected Reticle
  if (is_focused && iPreviousCursor.z > 0.0 && iPreviousCursor.w > 0.0) {

    // Clean Connected Bracket Reticle Animation (Only on keypress / cursor move)
