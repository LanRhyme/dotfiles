...
const PALETTE_COMMANDS: PaletteCommand[] = [
	...
	},
	{
		...
		category: "常用",
		cnName: "工作区代码与对话回溯",
		description: "可视化 Git 快照回溯与预览代码 Diff",
	},
	{
		name: "undo",
		category: "常用",
		cnName: "快捷撤销上一步修改",
		description: "撤销上一步 AI 对本地文件做出的改动",
	},
	{
		name: "redo",
		category: "常用",
		cnName: "恢复上一步撤销修改",
		description: "恢复上一步被撤销的代码改动",
	},
	{
		name: "websearch",
		category: "常用",
		cnName: "AnySearch 联网搜索",
		description: "全功能联网搜索与网页/PDF解析",
	},
	{
		name: "search",
		category: "常用",
		cnName: "快捷联网搜索",
		description: "搜索并直接返回 AI 总结摘要",
	},
	{
		name: "model",
		category: "常用",
	...
	},
	{
		name: "subagents",
		category: "常用",
		cnName: "Sub-agents 子代理控制台",
		description: "管理、监控与调度后台协同 Sub-agent",
	},
	{
		name: "goal",
		category: "常用",
		cnName: "自主目标循环修复",
		description: "开启自主目标拆解，自动测试与修复",
	},
	{
		name: "plan",
		category: "常用",
		cnName: "只读规划模式",
		description: "Codex 风格 /plan — 动手前进入只读规划，批注审查 AI 方案",
	},
	{
		name: "btw",
		category: "常用",
		cnName: "侧边快速提问",
		description: "问个小问题不打断主对话，独立线程回答",
	},
	{
		name: "piolium-lite",
		category: "常用",
		cnName: "快速安全与密钥扫描",
		description: "快速扫描代码库密钥泄露与安全隐患",
	},
	{
		name: "usage",
		category: "常用",
		cnName: "Token 消耗与资费看板",
		description: "实时统计模型 Token 消耗与费用",
	},
	{
		name: "extmgr",
		category: "常用",
	...
	// 高级命令
	{
		...
		category: "高级",
		cnName: "分化新会话分支",
		description: "派生新分支，不污染主会话",
	},
	{
		name: "label",
		category: "高级",
		cnName: "标记当前对话节点",
		description: "设置黄色高亮标记方便精准回溯",
	},
	{
		name: "session",
		category: "高级",
		cnName: "历史会话管理",
		description: "切换、管理与导出历史 Session",
	},
	{
		name: "compact",
		category: "高级",
		cnName: "压缩会话上下文",
		description: "手动将历史对话总结为结构化摘要",
	},
	{
		name: "memctx",
		category: "高级",
		cnName: "Markdown 长期记忆",
		description: "管理项目 MEMORY.md 知识库",
	},
	{
		name: "lean-ctx",
		category: "高级",
		cnName: "Token 极限压缩看板",
		description: "查看 MCP Session 缓存与压缩率",
	},
	{
		name: "lens",
		category: "高级",
		cnName: "代码质量与 LSP 检查",
		description: "运行 LSP 语言服务与 Linter 检查",
	},
	{
		name: "spawn",
		category: "高级",
		cnName: "终端 Overlay 浮窗",
		description: "在浮窗中运行 vim, lazygit 等 CLI",
	},
	{
		name: "attach",
		category: "高级",
		cnName: "连接交互终端",
		description: "重新连接后台运行的交互终端",
	},
	{
		name: "chrome-devtools",
		category: "高级",
		cnName: "Chrome 浏览器调试",
		description: "CDP 连接 Chrome：开标签、导航、截图、执行 JS",
	},
	{
		name: "piolium-deep",
		category: "高级",
		cnName: "深度多阶段漏洞挖掘",
		description: "对代码进行深度多阶段安全审计",
	},
	...
	// 配置与系统
	{
		...
		category: "配置",
		cnName: "ZentUI 主题设置",
		description: "配置固定底部输入框与 Starship 状态栏",
	},
	{
		name: "open-tui",
		category: "配置",
		cnName: "OpenTUI 顶栏设置",
		description: "配置直角 ASCII Art Logo 顶栏",
	},
	{
		name: "stamp",
		category: "配置",
		cnName: "时间戳与耗时显示",
		description: "配置会话时间戳、助手元数据与工具耗时显示",
	},
	{
		name: "curator",
		category: "配置",
		cnName: "开关搜索审查界面",
		description: "开启或关闭搜索 Live Browser Curator",
	},
	{
		name: "clear",
		category: "系统",
	...
	},
	{
		...
		category: "系统",
		cnName: "帮助文档",
		description: "查看 Pi Agent 官方使用帮助与指南",
	},
];
...
class CommandPaletteComponent extends Container {
	...
	constructor(
		...
		this.addChild(
			new Text(
				theme.bold(
					theme.fg("accent", "  🔍 Pi Agent 命令面板 (Command Palette)"),
				),
				0,
				0,
			),
		...
		this.addChild(
			new Text(
				theme.fg("dim", "  打字直接搜索 · ↑/↓: 选择 · Enter: 执行 · Esc: 关闭"),
				0,
				0,
			),
		);
	...
	private filterCommands(query: string): void {
		...
		if (!q) {
			...
			this.filteredCommands = PALETTE_COMMANDS.filter(
				(cmd) =>
	...
	private updateList(): void {
		...
		const startIndex = Math.max(
			...
			Math.min(
				...
				this.filteredCommands.length - maxVisible,
			),
		);
		const safeStartIdx = Math.max(0, startIndex);
		const endIndex = Math.min(
			safeStartIdx + maxVisible,
			this.filteredCommands.length,
		);

		if (this.filteredCommands.length === 0) {
			this.listContainer.addChild(
				new Text(this.theme.fg("warning", "  未找到匹配的指令"), 0, 0),
			);
			return;
		}
		...
		if (this.filteredCommands.length > 0) {
			...
			const descText = selected
				? this.theme.fg("muted", `  💡 说明: ${selected.description}`)
				: "";
...
export default function (pi: ExtensionAPI) {
	...
	pi.registerShortcut("alt+x", {
		description: "打开中文命令面板 (Command Palette)",
		handler: async (ctx) => {
			if (!ctx.hasUI) return;
			const registered = pi.getCommands();
			const cmdObj = registered.find((c) => c.name === "cmd");
